...
import dev.namelessnanashi.walrus.device.proxmark3.Proxmark3Device;
...
public enum CardDeviceManager {
    ...
    public static final String ACTION_UPDATE =
            "dev.namelessnanashi.walrus.device.CardDeviceManager.ACTION_UPDATE";
    public static final String EXTRA_DEVICE_WAS_ADDED =
            "dev.namelessnanashi.walrus.device.CardDeviceManager.EXTRA_DEVICE_WAS_ADDED";
    public static final String EXTRA_DEVICE_ID =
            "dev.namelessnanashi.walrus.device.CardDeviceManager.EXTRA_DEVICE_ID";
    public static final String EXTRA_DEVICE_NAME =
            "dev.namelessnanashi.walrus.device.CardDeviceManager.EXTRA_DEVICE_NAME";

    private static final String ACTION_USB_PERMISSION_RESULT =
            "dev.namelessnanashi.walrus.device.CardDeviceManager"
