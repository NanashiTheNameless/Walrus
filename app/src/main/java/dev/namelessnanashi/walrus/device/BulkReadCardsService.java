...
public class BulkReadCardsService extends Service {
    ...
    public static final String ACTION_UPDATE =
            "dev.namelessnanashi.walrus.device.BulkReadCardsService.ACTION_UPDATE";

    private static final String EXTRA_READ_CARD_DATA_OPERATION =
            "dev.namelessnanashi.walrus.device.BulkReadCardsService"
                    + ".EXTRA_READ_CARD_DATA_OPERATION";
    private static final String EXTRA_CARD_TEMPLATE =
            "dev.namelessnanashi.walrus.device.BulkReadCardsService.EXTRA_CARD_TEMPLATE";
